...
namespace Assets.Systems.Src.Atmosphere
{
    ...
    {
        public IAtmospherics self;

        public Pascal pressure = 0;
        public Kelvin temperature = 0;
        public ResourceComposition[] composition;

        public AtmosphereState(string name, int update, IAtmospherics self, ResourceComposition[] composition, Pascal pressure, Kelvin temperature) : base(name, update)
        {
            this.self = self;
